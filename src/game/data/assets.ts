...
export const CORE_IMAGE_ASSETS: AssetManifestEntry[] = [
  ...
  { key: 'placeholder_portrait', type: 'placeholder', path: '/assets/ui/placeholders/fallback-icon.png', primaryPath: '/assets/ui/placeholders/fallback-icon.png', fallbackPaths: ['/assets/ui/fallback-icon.png'], kind: 'sprite' },
  { key: 'placeholder_background', type: 'placeholder', path: '/assets/placeholders/fallback-background.png', primaryPath: '/assets/placeholders/fallback-background.png', fallbackPaths: ['/assets/stages/fallback-background.png'], kind: 'background' },
  { key: 'placeholder_panel', type: 'placeholder', path: '/assets/ui/panels/ui_panel_default.png', primaryPath: '/assets/ui/panels/ui_panel_default.png', fallbackPaths: ['/assets/ui/placeholders/fallback-missing.png'], kind: 'ui' },
  ...
  { key: 'ui_button_primary', type: 'ui', path: '/assets/ui/buttons/ui_button_primary.png', primaryPath: '/assets/ui/buttons/ui_button_primary.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_secondary', type: 'ui', path: '/assets/ui/buttons/ui_button_secondary.png', primaryPath: '/assets/ui/buttons/ui_button_secondary.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  ...
  { key: 'bg_scene_shop', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_shop.png', primaryPath: '/assets/stages/global-scenes/bg_scene_shop.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_settings', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_settings.png', primaryPath: '/assets/stages/global-scenes/bg_scene_settings.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'ui_panel_shop', type: 'ui', path: '/assets/ui/panels/ui_panel_shop.png', primaryPath: '/assets/ui/panels/ui_panel_shop.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_shop_item_card', type: 'ui', path: '/assets/ui/panels/ui_shop_item_card.png', primaryPath: '/assets/ui/panels/ui_shop_item_card.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_button_buy', type: 'ui', path: '/assets/ui/buttons/ui_button_buy.png', primaryPath: '/assets/ui/buttons/ui_button_buy.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_sell', type: 'ui', path: '/assets/ui/buttons/ui_button_sell.png', primaryPath: '/assets/ui/buttons/ui_button_sell.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_panel_inventory', type: 'ui', path: '/assets/ui/panels/ui_panel_inventory.png', primaryPath: '/assets/ui/panels/ui_panel_inventory.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_inventory_item_card', type: 'ui', path: '/assets/ui/panels/ui_inventory_item_card.png', primaryPath: '/assets/ui/panels/ui_inventory_item_card.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_inventory_detail_panel', type: 'ui', path: '/assets/ui/panels/ui_inventory_detail_panel.png', primaryPath: '/assets/ui/panels/ui_inventory_detail_panel.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_panel_settings', type: 'ui', path: '/assets/ui/panels/ui_panel_settings.png', primaryPath: '/assets/ui/panels/ui_panel_settings.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_tab_audio', type: 'ui', path: '/assets/ui/buttons/ui_tab_audio.png', primaryPath: '/assets/ui/buttons/ui_tab_audio.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_tab_accessibility', type: 'ui', path: '/assets/ui/buttons/ui_tab_accessibility.png', primaryPath: '/assets/ui/buttons/ui_tab_accessibility.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_tab_controls', type: 'ui', path: '/assets/ui/buttons/ui_tab_controls.png', primaryPath: '/assets/ui/buttons/ui_tab_controls.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_slider_default', type: 'ui', path: '/assets/ui/meters/ui_slider_default.png', primaryPath: '/assets/ui/meters/ui_slider_default.png', fallbackPaths: ['/assets/ui/meters/ui_meter_fallback.png', '/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_toggle_on', type: 'ui', path: '/assets/ui/buttons/ui_toggle_on.png', primaryPath: '/assets/ui/buttons/ui_toggle_on.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'ui' },
  { key: 'ui_toggle_off', type: 'ui', path: '/assets/ui/buttons/ui_toggle_off.png', primaryPath: '/assets/ui/buttons/ui_toggle_off.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'ui' },
  { key: 'ui_button_apply', type: 'ui', path: '/assets/ui/buttons/ui_button_apply.png', primaryPath: '/assets/ui/buttons/ui_button_apply.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_back', type: 'ui', path: '/assets/ui/buttons/ui_button_back.png', primaryPath: '/assets/ui/buttons/ui_button_back.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'bg_scene_splash', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_splash.png', primaryPath: '/assets/stages/global-scenes/bg_scene_splash.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_main_menu', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_main_menu.png', primaryPath: '/assets/stages/global-scenes/bg_scene_main_menu.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_hero_select', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_hero_select.png', primaryPath: '/assets/stages/global-scenes/bg_scene_hero_select.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_defeat', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_defeat.png', primaryPath: '/assets/stages/global-scenes/bg_scene_defeat.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_defeat_summary', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_defeat_summary.png', primaryPath: '/assets/stages/global-scenes/bg_scene_defeat_summary.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_victory', type: 'story', path: '/assets/story/endings/bg_scene_victory.png', primaryPath: '/assets/story/endings/bg_scene_victory.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'bg_scene_victory_ending', type: 'story', path: '/assets/story/endings/bg_scene_victory_ending.png', primaryPath: '/assets/story/endings/bg_scene_victory_ending.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'ui_panel_main_menu', type: 'ui', path: '/assets/ui/panels/ui_panel_main_menu.png', primaryPath: '/assets/ui/panels/ui_panel_main_menu.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_panel_hero_select', type: 'ui', path: '/assets/ui/panels/ui_panel_hero_select.png', primaryPath: '/assets/ui/panels/ui_panel_hero_select.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_hero_card', type: 'ui', path: '/assets/ui/panels/ui_hero_card.png', primaryPath: '/assets/ui/panels/ui_hero_card.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_panel_run_summary', type: 'ui', path: '/assets/ui/panels/ui_panel_run_summary.png', primaryPath: '/assets/ui/panels/ui_panel_run_summary.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_panel_victory', type: 'ui', path: '/assets/ui/panels/ui_panel_victory.png', primaryPath: '/assets/ui/panels/ui_panel_victory.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_button_new_run', type: 'ui', path: '/assets/ui/buttons/ui_button_new_run.png', primaryPath: '/assets/ui/buttons/ui_button_new_run.png', fallbackPaths: ['/assets/ui/buttons/ui_button_primary.png', '/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_continue', type: 'ui', path: '/assets/ui/buttons/ui_button_continue.png', primaryPath: '/assets/ui/buttons/ui_button_continue.png', fallbackPaths: ['/assets/ui/buttons/ui_button_secondary.png', '/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_settings', type: 'ui', path: '/assets/ui/buttons/ui_button_settings.png', primaryPath: '/assets/ui/buttons/ui_button_settings.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_icon', type: 'ui', path: '/assets/ui/buttons/ui_button_icon.png', primaryPath: '/assets/ui/buttons/ui_button_icon.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  ...
  { key: 'bg_scene_reward', type: 'stage_background', path: '/assets/stages/global-scenes/bg_scene_reward.png', primaryPath: '/assets/stages/global-scenes/bg_scene_reward.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'ui_panel_reward', type: 'ui', path: '/assets/ui/panels/ui_panel_reward.png', primaryPath: '/assets/ui/panels/ui_panel_reward.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_reward_banner', type: 'ui', path: '/assets/ui/hud/ui_reward_banner.png', primaryPath: '/assets/ui/hud/ui_reward_banner.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_reward_card_common', type: 'ui', path: '/assets/ui/panels/ui_reward_card_common.png', primaryPath: '/assets/ui/panels/ui_reward_card_common.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_reward_card_rare', type: 'ui', path: '/assets/ui/panels/ui_reward_card_rare.png', primaryPath: '/assets/ui/panels/ui_reward_card_rare.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_reward_card_epic', type: 'ui', path: '/assets/ui/panels/ui_reward_card_epic.png', primaryPath: '/assets/ui/panels/ui_reward_card_epic.png', fallbackPaths: ['/assets/ui/panels/ui_reward_card_rare.png', '/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_button_reward_claim', type: 'ui', path: '/assets/ui/buttons/ui_button_reward_claim.png', primaryPath: '/assets/ui/buttons/ui_button_reward_claim.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_button_reward_continue', type: 'ui', path: '/assets/ui/buttons/ui_button_reward_continue.png', primaryPath: '/assets/ui/buttons/ui_button_reward_continue.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_reward_empty_state', type: 'ui', path: '/assets/ui/panels/ui_reward_empty_state.png', primaryPath: '/assets/ui/panels/ui_reward_empty_state.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_panel_node_preview', type: 'ui', path: '/assets/ui/panels/ui_panel_node_preview.png', primaryPath: '/assets/ui/panels/ui_panel_node_preview.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_map_path_unlocked', type: 'ui', path: '/assets/ui/hud/ui_map_path_unlocked.png', primaryPath: '/assets/ui/hud/ui_map_path_unlocked.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_map_path_locked', type: 'ui', path: '/assets/ui/hud/ui_map_path_locked.png', primaryPath: '/assets/ui/hud/ui_map_path_locked.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ico_node_normal', type: 'icon', path: '/assets/icons/map-nodes/ico_node_normal.png', primaryPath: '/assets/icons/map-nodes/ico_node_normal.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_elite', type: 'icon', path: '/assets/icons/map-nodes/ico_node_elite.png', primaryPath: '/assets/icons/map-nodes/ico_node_elite.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_event', type: 'icon', path: '/assets/icons/map-nodes/ico_node_event.png', primaryPath: '/assets/icons/map-nodes/ico_node_event.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_shop', type: 'icon', path: '/assets/icons/map-nodes/ico_node_shop.png', primaryPath: '/assets/icons/map-nodes/ico_node_shop.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_rest', type: 'icon', path: '/assets/icons/map-nodes/ico_node_rest.png', primaryPath: '/assets/icons/map-nodes/ico_node_rest.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_treasure', type: 'icon', path: '/assets/icons/map-nodes/ico_node_treasure.png', primaryPath: '/assets/icons/map-nodes/ico_node_treasure.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_boss', type: 'icon', path: '/assets/icons/map-nodes/ico_node_boss.png', primaryPath: '/assets/icons/map-nodes/ico_node_boss.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_current', type: 'icon', path: '/assets/icons/map-nodes/ico_node_current.png', primaryPath: '/assets/icons/map-nodes/ico_node_current.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_node_completed', type: 'icon', path: '/assets/icons/map-nodes/ico_node_completed.png', primaryPath: '/assets/icons/map-nodes/ico_node_completed.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'bg_stage_sprinkle_sewers_intro', type: 'stage_background', path: '/assets/stages/stage_sprinkle_sewers/route-scenes/bg_stage_sprinkle_sewers_intro.png', primaryPath: '/assets/stages/stage_sprinkle_sewers/route-scenes/bg_stage_sprinkle_sewers_intro.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'ui_panel_boss_rule', type: 'ui', path: '/assets/ui/panels/ui_panel_boss_rule.png', primaryPath: '/assets/ui/panels/ui_panel_boss_rule.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ico_boss_cupcake_slime_king', type: 'icon', path: '/assets/portraits/bosses/boss_cupcake_slime_king__portrait_icon__f00.png', primaryPath: '/assets/portraits/bosses/boss_cupcake_slime_king__portrait_icon__f00.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ico_boss_rule_boss_cupcake_slime_king', type: 'icon', path: '/assets/icons/boss-rules/ico_boss_rule_boss_cupcake_slime_king.png', primaryPath: '/assets/icons/boss-rules/ico_boss_rule_boss_cupcake_slime_king.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ui_button_start_boss', type: 'ui', path: '/assets/ui/buttons/ui_button_start_boss.png', primaryPath: '/assets/ui/buttons/ui_button_start_boss.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'bg_route_milo_sprinkle_sewers', type: 'story', path: '/assets/stages/stage_sprinkle_sewers/route-scenes/bg_route_milo_sprinkle_sewers.png', primaryPath: '/assets/stages/stage_sprinkle_sewers/route-scenes/bg_route_milo_sprinkle_sewers.png', fallbackPaths: ['/assets/placeholders/fallback-background.png'], kind: 'background' },
  { key: 'ui_panel_dialogue', type: 'ui', path: '/assets/ui/panels/ui_panel_dialogue.png', primaryPath: '/assets/ui/panels/ui_panel_dialogue.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_dialogue_nameplate', type: 'ui', path: '/assets/ui/panels/ui_dialogue_nameplate.png', primaryPath: '/assets/ui/panels/ui_dialogue_nameplate.png', fallbackPaths: ['/assets/ui/panels/ui_panel_default.png'], kind: 'ui' },
  { key: 'ui_choice_card_practical', type: 'ui', path: '/assets/ui/story-routes/ui_choice_card_practical.png', primaryPath: '/assets/ui/story-routes/ui_choice_card_practical.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_choice_card_true', type: 'ui', path: '/assets/ui/story-routes/ui_choice_card_true.png', primaryPath: '/assets/ui/story-routes/ui_choice_card_true.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'ui_choice_card_risky', type: 'ui', path: '/assets/ui/story-routes/ui_choice_card_risky.png', primaryPath: '/assets/ui/story-routes/ui_choice_card_risky.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' },
  { key: 'portrait_hero_milo_blockmancer', type: 'portrait', path: '/assets/portraits/heroes/portrait_hero_milo_blockmancer.png', primaryPath: '/assets/portraits/heroes/portrait_hero_milo_blockmancer.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'sprite' },
  { key: 'portrait_npc_bloop', type: 'portrait', path: '/assets/portraits/npcs/portrait_npc_bloop.png', primaryPath: '/assets/portraits/npcs/portrait_npc_bloop.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'sprite' },
  { key: 'ico_route_true_flag', type: 'icon', path: '/assets/icons/route-story/ico_route_true_flag.png', primaryPath: '/assets/icons/route-story/ico_route_true_flag.png', fallbackPaths: ['/assets/ui/placeholders/fallback-icon.png'], kind: 'icon' },
  { key: 'ui_button_skip_dialogue', type: 'ui', path: '/assets/ui/buttons/ui_button_skip_dialogue.png', primaryPath: '/assets/ui/buttons/ui_button_skip_dialogue.png', fallbackPaths: ['/assets/ui/buttons/ui_button_default.png'], kind: 'ui' }
];
